    ...
    <div class="mt-8">
        <form action="#" autoComplete="off">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="flex items-center mb-6 -mt-4">
                        <div class="flex ml-auto">
                            <a href="button" class="inline-flex text-xs font-thin text-gray-500 sm:text-sm dark:text-gray-100 hover:text-gray-700 dark:hover:text-white">
            ...
            <div class="flex items-center justify-center mt-6">
                <a href="button" target="_blank" class="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white"  onClick={history.push("/Register")}>
                    <span class="ml-2">
